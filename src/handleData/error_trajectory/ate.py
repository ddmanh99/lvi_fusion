...
if __name__=="__main__":
    ...
    save_dir  = save_fol+'/'+'ate_'+dt_string+'.png'
    ...
    parser.add_argument('--plot', help='plot the first and the aligned second trajectory to an image (format: png)',default=save_dir)
    parser.add_argument('--verbose', help='print all evaluation data (otherwise, only the RMSE absolute translational error in meters after alignment will be printed)', action='store_true',default=1)
