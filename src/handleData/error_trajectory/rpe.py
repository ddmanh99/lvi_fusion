...
if __name__ == '__main__':
    ...
    save_dir  = save_fol+'/'+'rpe_'+dt_string+'.png'
    ...
    parser.add_argument('--plot', help='plot the result to a file (requires --fixed_delta, output format: png)',default=save_dir)
    parser.add_argument('--verbose', help='print all evaluation data (otherwise, only the mean translational error measured in meters will be printed)', action='store_true',default=1)
    ...
    if args.verbose:
        ...
        print (f"translational_error.rmse {numpy.sqrt(numpy.dot(trans_error,trans_error) / len(trans_error))} m")
        print (f"translational_error.mean {numpy.mean(trans_error)} m")
        print (f"translational_error.median {numpy.median(trans_error)} m")
        print (f"translational_error.std {numpy.std(trans_error)} m")
        print (f"translational_error.min {numpy.min(trans_error)} m")
        print (f"translational_error.max {numpy.max(trans_error)} m")

        print (f"rotational_error.rmse {(numpy.sqrt(numpy.dot(rot_error,rot_error) / len(rot_error)) * 180.0 / numpy.pi)} deg")
        print (f"rotational_error.mean {(numpy.mean(rot_error) * 180.0 / numpy.pi)} deg")
        print (f"rotational_error.median {(numpy.median(rot_error) * 180.0 / numpy.pi)} deg")
        print (f"rotational_error.std {(numpy.std(rot_error) * 180.0 / numpy.pi)} deg")
        print (f"rotational_error.min {(numpy.min(rot_error) * 180.0 / numpy.pi)} deg")
        print (f"rotational_error.max {(numpy.max(rot_error) * 180.0 / numpy.pi)} deg")
    else:
